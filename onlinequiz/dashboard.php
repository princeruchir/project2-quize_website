...
<body>
    <nav class="navbar navbar-default title1">
        <!-- <div class="container-fluid" style="background-color: #234E70; border: 2px solid black;"> -->
        <div class="container-fluid" style="background-color:#101820; border: 1px solid #FEE715;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <a class="navbar-brand" href="Javascript:void(0)"><b>QG</b></a>
                <ul class="nav navbar-nav navbar-left" style="position: absolute; left: 35%; ">
                    <li <?php if (@$_GET['q'] == 0) echo ''; ?>><a href="dashboard.php?q=0">HOME<span class="sr-only">(current)</span></a></li>
                    <li <?php if (@$_GET['q'] == 1) echo ''; ?>><a href="dashboard.php?q=1">USER</a></li>
                    <li <?php if (@$_GET['q'] == 2) echo ''; ?>><a href="dashboard.php?q=2">RANKING</a></li>
                    <li class="dropdown <?php if (@$_GET['q'] == 4 || @$_GET['q'] == 5) echo 'active"'; ?>">
                    <li><a href="dashboard.php?q=4">ADD QUIZ</a></li>
                    <li><a href="dashboard.php?q=5">REMOVE QUIZ</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    <li <?php echo ''; ?>> <a href="logout1.php?q=dashboard.php" style="color:blue">&nbsp;LOG OUT</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if (@$_GET['q'] == 0) {
                    echo "<h1> WELCOME TO THE ADMIN PAGE
					</h1>";
                }
                ...
                if (@$_GET['q'] == 5) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<tr><td><center>' . $c++ . '</center></td><td><center>' . $title . '</center></td><td><center>' . $total . '</center></td><td><center>' . $sahi * $total . '</center></td>
                            <td><center><b><a href="update.php?q=rmquiz&eid=' . $eid . '" class="pull-right btn sub1" style="margin:0px;background:red;color:black; margin-right: 30%;"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></center></td></tr>';
                    }
                    $c = 0;
                    echo '</table></div></div>';
                }
